...
/**
 * This class implements the main starting point for our Wall Follower.
 * 
...
public class WallFollowingLab {
  ...
  private static final int motorLow = 100; // (100) Speed of slower rotating wheel (deg/sec)
  private static final int motorHigh = 200; // (200) Speed of the faster rotating wheel (deg/seec)


  private static final Port usPort = LocalEV3.get().getPort("S1");

  /**
   * This variable stores a global EV3LargeRegulatedMotor instance that denotes the left motor and
   * can be manipulated by other classes in the WallFollowingLab project.
   */
  public static final EV3LargeRegulatedMotor leftMotor =
      new EV3LargeRegulatedMotor(LocalEV3.get().getPort("B"));

  /**
   * This variable stores a global EV3LargeRegulatedMotor instance that denotes the right motor and
   * can be manipulated by other classes in the WallFollowingLab project.
   */
